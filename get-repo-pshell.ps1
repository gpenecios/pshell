...
$repo = "https://gitlab.engr.illinois.edu/glennp/pshell"
# https://gitlab.engr.illinois.edu/glennp/pshell/-/archive/main/pshell-main.zip
$zipURL = "$repo/-/archive/main/pshell-main.zip"
log "Zip URL: $zipURL"
